...
<%
    ...
    String[] birthday = udd.getBirthday().toString().split("-",0);
    int[] birthdayNum = new int[3];
    for(int i = 0;i < birthday.length;i++){
            birthdayNum[i] = Integer.parseInt(birthday[i]); 
    }
%>
...
<html>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
    ...
    <form action="UpdateResult" method="POST">
        ...
        <br>
            <% for(int i = 1; i<=3; i++){ %>
            <input type="radio" name="type" value="<%=udd.getType()%>"<%
                if(i == udd.getType()){
                    out.print("checked");
                }%>>
            <%=jh.exTypenum(i)%><br>
